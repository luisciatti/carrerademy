                            ...
                            {question.options.map((option, optionIndex) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`rounded-lg border px-3 py-2 text-left text-sm ${selected ? "border-teal-400 bg-teal-500/15 text-teal-100" : "border-border text-muted"}`}
                                    >
                                        {option}
                                    </button>
                                );
    ...
    return (
        <div className="space-y-5">
            ...
            <TrailHeaderCard
                ...
                onKindChange={(kind) => router.push(`/trilha?kind=${kind}`)}
                recentlyCompleted={!!recentlyCompletedStepId}
            />

            {selectedKind === "STANDARD_SOFT_SKILLS" && (
